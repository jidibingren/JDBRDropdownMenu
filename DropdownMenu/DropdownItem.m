...
//        CGSize titleSize = [title sizeWithAttributes:@{NSFontAttributeName:DDTEXTFONT(13)}];
...
- (UILabel *)titleLabel {
    ...
    if (!_titleLabel) {
        ...
        _titleLabel.font = DDTEXTFONT(13);
        _titleLabel.textColor = DDColorWihtRGBA(68, 68, 68);
    }
    return _titleLabel;
}
